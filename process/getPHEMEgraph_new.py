...
def main():
    treePath = '../data/PHEME/data.TD_RvNN.vol_5000.txt'
    """
    文件结构：
    ...
    labelPath = '../data/PHEME/data.label.txt'
    labelset_R, labelset_NR = ['rumours'], ['non-rumours']
    ...
    def loadEid(event, id, y):
        ...
        if len(event) > 1:
            ...
            np.savez('../data/PHEME/PHEMEgraph/' + id + '.npz', x=x_x, root=rootfeat, edgeindex=tree, rootindex=rootindex, y=y,
                     division=division)
            return None
